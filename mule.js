...
function deliverLoad(creep) {
    ...
    var target = _.find(creep.room.find(FIND_STRUCTURES), function (struct) { return (struct.structureType == STRUCTURE_EXTENSION
...
module.exports = {
    run: function (creep) {
        ...
        var droppedResource = source.pos.findClosestByRange(FIND_DROPPED_ENERGY);
